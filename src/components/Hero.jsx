  ...
  return (
    <>
        ...
        >   
            ...
            <ScrollControls className="scrollcontrols" pages={5.2} damping={0.25}>
              <Suspense>
                <Float
                  speed={3}
                  rotationIntensity={.2}
              ...
              <Scroll html style={{width: '100%'}}>
                  <div className='align-items-center justify-content-center' style={{position: 'absolute',width: '100%',height: '100vh', paddingRight:0, paddingLeft:0, paddingTop:200}}>
                    <Col 
                    md={12} xs={12}
                    >
                  ...
                  <div className='align-items-center' style={{position: 'absolute',width: '100%',height: '50vh', top: '100vh'}}>
                    <Col md={12} xs={12}
                      className='row-page'
                    >
                      <div className='container'>
                  ...
                  <div className='justify-content-center' style={{position: 'absolute',width: '100%',height: '200vh', top: '200vh'}}>
                    ...
                    >
                      ...
                      <div className='pf_div'>
                        <Japanhouse scale={0.4} position={[0, 0, 0]} rotation={[ 0, -2.5, 0]}/>

                        <PortFolio/>
                      </div>
                    </Col>
                  </div>  
                  <div className='align-items-center justify-content-center' style={{position: 'absolute',width: '100%',height: '50vh', top: '470vh'}}>
